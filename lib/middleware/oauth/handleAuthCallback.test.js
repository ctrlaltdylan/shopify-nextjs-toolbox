...
describe('Handling the Shopify OAuth callback response', function () {
  ...
  test("it redirects to the provided path if the handler returns a custom path with the shop query param appended automatically", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            expect(res.redirect).toHaveBeenCalledWith("https://getverdict.com/a-custom-path?shop=test.myshopify.com&host=dylanwashere&signature=123123");
