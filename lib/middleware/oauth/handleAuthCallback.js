...
var _default = function _default(handler, options) {
  return /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
      var valid, validateNonce, validNonce, accessTokenQuery, accessToken, redirectPath, redirectUrl;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 25:
              ...
              if (redirectPath && redirectPath.includes('?')) {
                redirectUrl = "".concat(redirectPath, "&").concat(_querystring["default"].stringify(req.query));
              } else {
                redirectUrl = "".concat(redirectPath || process.env.HOME_PATH, "?").concat(_querystring["default"].stringify(req.query));
              }
